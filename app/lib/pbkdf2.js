...
var CryptoJS = CryptoJS || function(g, i) {
  var f = {}, b = f.lib = {},
      ...
      l = b.WordArray = m.extend({
        ...
        toString : function(a) { return (a || d).stringify(this) },
        concat : function(a) {
      ...
      k = n.Utf8 = {
        ...
        parse : function(a) { return j.parse(unescape(encodeURIComponent(a))) }
      },
      h = b.BufferedBlockAlgorithm = m.extend({
        ...
        _process : function(a) {
          var b = this._data, c = b.words, d = b.sigBytes, j = this.blockSize, h = d / (4 * j),
              h = a ? g.ceil(h) : g.max((h | 0) - this._minBufferSize, 0), a = h * j,
              d = g.min(4 * a, d);
          if (a) {
            for (var f = 0; f < a; f += j)
  ...
  b.Hasher = h.extend({
    ...
    _createHmacHelper : function(a) {
      return function(b, c) { return u.HMAC.create(a, c).finalize(b) }
    }
  });
  var u = f.algo = {};
  return f
...
var g = CryptoJS, i = g.lib, f = i.WordArray, i = i.Hasher, b = [], m = g.algo.SHA1 = i.extend({
  ...
  _doProcessBlock : function(f, n) {
    for (var d = this._hash.words, j = d[0], k = d[1], h = d[2], g = d[3], a = d[4], e = 0; 80 > e;
         e++) {
      if (16 > e)
        b[e] = f[n + e] | 0;
      else {
...
g.algo.HMAC = g.lib.Base.extend({
  init : function(f, b) {
    ...
    for (var n = this._oKey = b.clone(), d = this._iKey = b.clone(), j = n.words, k = d.words,
             h = 0;
         h < g; h++)
...
(function() {
var g = CryptoJS, i = g.lib, f = i.Base, b = i.WordArray, i = g.algo, m = i.HMAC,
    l = i.PBKDF2 = f.extend({
      cfg : f.extend({keySize : 4, hasher : i.SHA1, iterations : 1}),
      init : function(b) { this.cfg = this.cfg.extend(b) },
      compute : function(f, d) {
        for (var g = this.cfg, k = m.create(g.hasher, f), h = b.create(), i = b.create([ 1 ]),
                 a = h.words, e = i.words, c = g.keySize, g = g.iterations;
             a.length < c;) {
...
g.PBKDF2 = function(b, d, f) { return l.create(f).compute(b, d) }
})();
